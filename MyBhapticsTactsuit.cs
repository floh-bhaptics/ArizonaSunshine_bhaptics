...
#pragma warning restore CS0618
        ...
        public void Recoil(string weaponName, bool isRightHand, bool isTwoHanded, float intensity = 1.0f)
        {
            ...
            if (isTwoHanded)
            {
                bHapticsLib.bHapticsManager.PlayRegistered(keyOffHand, keyOffHand, scaleOption, rotationFront);
                bHapticsLib.bHapticsManager.PlayRegistered(keyOffArm, keyOffArm, scaleOption, rotationFront);
            }
